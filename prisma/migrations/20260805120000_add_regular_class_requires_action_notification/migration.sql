-- AlterTable: Notification — new type for a recurring-occurrence off-session
-- charge declined specifically for SCA/3DS authentication (PSD2 "authentication_required"),
-- distinct from a generic decline (see app/lib/regular-classes/materialize-occurrences.ts)
ALTER TABLE `Notification` MODIFY COLUMN `type` ENUM(
    ...
    'regular_class_requires_action', 'payout_sent',
