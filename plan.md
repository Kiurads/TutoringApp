...
Note: none of the merged Phase 11 work has been build/typecheck/test-verified on a real Node 20+ install by a human — it was developed and CI-verified (Woodpecker's own environment is Node 20+), but worth a local sanity pass before relying on it, since it was never run on Node 20+ outside of CI.
